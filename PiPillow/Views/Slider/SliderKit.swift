...
public class SliderKit : NSObject {
    ...
    @objc public dynamic class func drawSlider(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 90, height: 94), resizing: ResizingBehavior = .aspectFit, strokeColor: UIColor = UIColor(red: 0.259, green: 0.325, blue: 0.498, alpha: 1.000), thumbColor: UIColor = UIColor(red: 0.800, green: 0.322, blue: 0.322, alpha: 1.000), gradientBottomColor: UIColor = UIColor(red: 0.835, green: 0.412, blue: 0.404, alpha: 1.000), messageColor: UIColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000), innerStrokeColor: UIColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000), startEndTextColor: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000), progress: CGFloat = 0.162, endAngle: CGFloat = -30, startAngle: CGFloat = 210, strokeWidth: CGFloat = 2, indicatorMessage: String = "", startText: String = "start", endText: String = "end") {
        ...
        let endTextAttrs = [NSAttributedStringKey.foregroundColor: UIColor.white, NSAttributedStringKey.font: UIFont(name: "Roboto-Light", size: 6)!, NSAttributedStringKey.paragraphStyle: endTextFieldStyle]
        
        let endTextFieldTextHeight: CGFloat = endText.boundingRect(with: CGSize(width: endTextFieldRect.width, height: CGFloat.infinity), options: .usesLineFragmentOrigin, attributes: endTextAttrs, context: nil).height
        context.saveGState()
        context.clip(to: endTextFieldRect)
        endText.draw(in: CGRect(x: endTextFieldRect.minX, y: endTextFieldRect.minY + (endTextFieldRect.height - endTextFieldTextHeight) / 2, width: endTextFieldRect.width, height: endTextFieldTextHeight), withAttributes: endTextAttrs)
        context.restoreGState()
        ...
        let startTextAttrs = [NSAttributedStringKey.foregroundColor: UIColor.white, NSAttributedStringKey.font: UIFont(name: "Roboto-Light", size: 5)!, NSAttributedStringKey.paragraphStyle: endTextFieldStyle]
        
        let startTextFieldTextHeight: CGFloat = startText.boundingRect(with: CGSize(width: startTextFieldRect.width, height: CGFloat.infinity), options: .usesLineFragmentOrigin, attributes: startTextAttrs, context: nil).height
        context.saveGState()
        context.clip(to: startTextFieldRect)
        startText.draw(in: CGRect(x: startTextFieldRect.minX, y: startTextFieldRect.minY + (startTextFieldRect.height - startTextFieldTextHeight) / 2, width: startTextFieldRect.width, height: startTextFieldTextHeight), withAttributes: startTextAttrs)
        context.restoreGState()
        ...
        let oval2TextAttrs = [NSAttributedStringKey.foregroundColor: UIColor.white, NSAttributedStringKey.font: UIFont(name: "Roboto-Light", size: 8)!, NSAttributedStringKey.paragraphStyle: endTextFieldStyle]
        
        let oval2TextHeight: CGFloat = indicatorMessage.boundingRect(with: CGSize(width: oval2Rect.width, height: CGFloat.infinity), options: .usesLineFragmentOrigin, attributes: oval2TextAttrs, context: nil).height
        context.saveGState()
        context.clip(to: oval2Rect)
        indicatorMessage.draw(in: CGRect(x: oval2Rect.minX, y: oval2Rect.minY + (oval2Rect.height - oval2TextHeight) / 2, width: oval2Rect.width, height: oval2TextHeight), withAttributes: oval2TextAttrs)
        context.restoreGState()
    ...
    @objc public dynamic class func drawRangeSlider(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 90, height: 94), resizing: ResizingBehavior = .aspectFit, strokeColor: UIColor = UIColor(red: 0.259, green: 0.325, blue: 0.498, alpha: 1.000), thumbColor: UIColor = UIColor(red: 0.800, green: 0.322, blue: 0.322, alpha: 1.000), gradientBottomColor: UIColor = UIColor(red: 0.835, green: 0.412, blue: 0.404, alpha: 1.000), messageColor: UIColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000), innerStrokeColor: UIColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000), startEndTextColor: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000), endAngle: CGFloat = -30, startAngle: CGFloat = 210, strokeWidth: CGFloat = 2, indicatorMessage: String = "", startText: String = "start", endText: String = "end", startValue: CGFloat = 0.351, endValue: CGFloat = 0.708) {
        ...
        let endTextFieldStyle = NSMutableParagraphStyle()
        endTextFieldStyle.alignment = .center
//        let endTextFieldFontAttributes = [kCTFontAttributeName: UIFont(name: "Roboto-Light", size: 6)!, kCTForegroundColorAttributeName: UIColor.white, kCTParagraphStyleAttributeName: endTextFieldStyle]
        ...
        let startTextFieldStyle = NSMutableParagraphStyle()
        startTextFieldStyle.alignment = .center
//        let startTextFieldFontAttributes = [kCTFontAttributeName: UIFont(name: "Roboto-Light", size: 6)!, kCTForegroundColorAttributeName: UIColor.white, kCTParagraphStyleAttributeName: startTextFieldStyle]
        
         let startTextAttrs = [NSAttributedStringKey.foregroundColor: UIColor.white, NSAttributedStringKey.font: UIFont(name: "Roboto-Light", size: 6)!, NSAttributedStringKey.paragraphStyle: endTextFieldStyle]
        ...
        let oval2Style = NSMutableParagraphStyle()
        oval2Style.alignment = .center
//        let oval2FontAttributes = [kCTFontAttributeName: UIFont(name: "HelveticaNeue", size: 8)!, kCTForegroundColorAttributeName: messageColor, kCTParagraphStyleAttributeName: oval2Style]
